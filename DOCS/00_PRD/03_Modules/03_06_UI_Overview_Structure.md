...
graph TD
    ...
    %% A4 - Search and Filter Controls - Horizontal Stack
    A4 --> A4a[Search Text Input - Leading Edge]
    A4 --> A4x[Horizontal Stack of Controls - Trailing Edge]

    A4x --> A4b[Appearance Mode Switch Button]
    A4x --> A4c[Favorites Access Button]
    A4x --> A4d[Waveform View Style Toggle Button]

    %% A5 - Transport Controls - Horizontal Stack
    A5 --> A5a[Large Circular Stop Button - Left]
    A5 --> A5b[Recording Status - Center]
    A5 --> A5c[Large Circular Record/Pause Button - Bottom]

    %% A5b Recording Status details - Vertical Stack
    A5b --> A5b1[Label RECORDING]
    A5b --> A5b2[Blinking Red Recording Indicator]

    %% A6 - Central Circular Playback Control
    A6 --> A6a[Center Circle - Play/Pause Button]
    ...
    A7 --> A7a[Lock Button - Bottom Left Screen Corner]
    A7 --> A7b[Info Button - Bottom Right Screen Corner]
```
